        ...
        <div id="contact" class="container parallax">
            ...
            <div class="inner contact">
                ...
                <div class="contact-form">
                    <!-- Form -->
                    <form id="contact-us" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        <!-- Left Inputs -->
                        <div class="col-xs-6 col-xs-12 animated" data-animation="fadeInLeft" data-animation-delay="300">
                             <?php echo $nameValid->getCssClassName(); ?>" 
							<span clas="error"><?php echo $nameValid->getErrorMessage(); ?></span> 
							<!-- Name -->
                            ...
                            <input type="email" name="mail" id="mail"  class="form" placeholder="Email" />
                             <span clas="error"><?php echo $emailValid->getErrorMessage(); ?></span>
							 <?php echo  $subjectValid-> getCssClassName(); ?>" 
							 <!-- Subject -->
                            <input type="text" name="subject" id="subject" class="form" placeholder="Subject" />
                             <span clas="error"><?php echo $subjectValid->getErrorMessage(); ?></span>        
						</div><!-- End Left Inputs -->
                        ...
                        <div class="col-xs-6 col-xs-12 animated" data-animation="fadeInRight" data-animation-delay="400">
                            ...
                            <span clas="error"><?php echo $messageValid->getErrorMessage(); ?></span>
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
	 					<?php include('errors.php'); ?>
							...
							<div class="form-group">
								...
								<input id="emailAddress" name="email" type="email" class="form-control input-lg"  placeholder="Enter email">
							...
							<div class= "form-group">
							<label for="why">Why do you want to visit this country?</label>
							<textarea name="why" id="why" style="width:250px; height:120px;"></textarea>
							<span class="error">* <?php echo $messageError;?></span>
							</div>
						<div class = "sign">
					<a href="register.php" class="sign">Not a member? Sign Up</a>
					</div>
                    
                    <div class="modal-footer">
                        <button type="submit" class="btn confirm-btn" name="login_user" >Confirm</button>
                    </div>
					</div>
					</form>
                </div>
