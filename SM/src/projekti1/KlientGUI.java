 ...
 */
public class KlientGUI extends JFrame implements ActionListener {
...
//	private JButton logout;
	...
	public KlientGUI(String host, int port, String user) {
...
//		}
		...
		if(o == login) {
			...
			client = new Klienti(server, port, username, this);
...
//			logout.setEnabled(true);
	...
	public static void main(String[] args) {
		new KlientGUI("localhost", 1500, "Anonymous");
	}
